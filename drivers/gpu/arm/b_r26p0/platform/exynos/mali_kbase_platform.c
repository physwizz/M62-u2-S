...
platform->tmu_lock_clk[0]=832000; // tmu control disabled so not use it //edit temp throttling
	platform->tmu_lock_clk[1]=802000; // tmu control disabled so not use it //edit temp throttling
	platform->tmu_lock_clk[2]=754000; // tmu control disabled so not use it //edit temp throttling
	platform->tmu_lock_clk[3]=650000; // tmu control disabled so not use it //edit temp throttling
	platform->tmu_lock_clk[4]=572000; //tmu control disabled so not use it //edit temp throttling
